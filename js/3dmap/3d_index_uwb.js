...
function load3dMap (){	
	viewer = new Cesium.Viewer('cesiumContainer',{
		...
		sceneMode: Cesium.SceneMode.COLUMBUS_VIEW,							//控制默认3D模式，可设置默认为2D\3D\2.5D模式						//控制默认3D模式，可设置默认为2D\3D\2.5D模式
    ...
    viewAddBottomMap(); 
	// 切换初始角度
    changeCamera([mapCenter(placeid)[0]+0.0003,mapCenter(placeid)[1]-0.00025],(floorid-1) * 3 +8000000,-42.4);
