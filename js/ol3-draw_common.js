...
"</div>";
var build = "<div class='input-group has-feedback' id='build'>" +
	"<span class='input-group-addon' id='build_key'>建筑编号</span>" +
	"<input class='form-control' id='build_value'>"+
	"<a class='btn close form-control-feedback' id='clear_build' onclick='clear_column(this);' style='pointer-events: auto'><span aria-hidden='true'>&times;</span></a>"+
"</div>";
