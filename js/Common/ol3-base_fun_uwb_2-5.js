...
function loadBasemap(){
	viewparams = 'place_id:' + placeid + ';floor_id:' + floorid;
	// 默认楼层
	// WFS
	...
	backgroundLayer.getSource().updateParams({viewparams:viewparams});
	// polygonLayer.getSource().clear();
	// polygonLayer.getSource().addFeatures(geomPolygons[floorid] != null ? geomPolygons[floorid]:[]);
	polygonLayer.getSource().updateParams({viewparams:viewparams});
